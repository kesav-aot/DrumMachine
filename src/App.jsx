...
function App() {
  ...
  const playSound = (key) => {
    const audioFiles = {
      Q: './assets/sounds/sound2.wav',
      W: './assets/sounds/public_sounds_hihat.wav',
      E: './assets/sounds/public_sounds_clap.wav',
      A: './assets/sounds/tom.wav',
      S: './assets/sounds/public_sounds_kick.wav',
      D: './assets/sounds/tom1d.wav',
      Z: './assets/sounds/public_sounds_snare.wav',
      X: './assets/sounds/sound1.wav',
      C: './assets/sounds/public_sounds_sub.wav',
    };
